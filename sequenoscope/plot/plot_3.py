...
# TODO: Change into directory based approach instead of file based approach
# TODO: Create a file to inherit a class for decision bar charts
# TODO: Change parameter and violin parameters names
# TODO: Ask Shannon about the minutes vs hours plots and get opinion
# * Refactor and get ready for dispatch by next week
...
def parse_args():
    ...
    parser_common.add_argument('--output_dir', type=str, required=True, help="[REQUIRED] Output directory designation")
    ...
    summary_parser = subparsers.add_parser('summary', parents=[parser_common], help='generate plots for summary seq manifest files')
    summary_parser._optionals.title = "Arguments"
    #summary_parser = ap.ArgumentParser(usage="nah kskdksdk ksdkskdk", add_help=False)
    ...
    summary_parser.add_argument('--plot_type', type=str, default= 'all', choices=['taxon_bar_chart', 'boxplot', 'ratio_bar_chart', 'single_ratio_bar_chart', 'stats_table', 'all'], help='the type of plot to generate. default is that all plots are generated')
    ...
    manifest_parser = subparsers.add_parser('manifest', parents=[parser_common], help='generate plots for seq manifest files')
